...
public interface MemberPlantMapper {
     ...
     */
    @Insert({
        "insert into tb_member_plant (PLANTID, USER_ID, ",
        "NAME, NICKNAME, ",
        "MEMO, THUMBNAIL, ",
        "START_DATE, WATER_ALARM, ",
        "WATER_CYCLE, LAST_WATER_DATE, ",
        "CREATE_DATE, MODIFY_DATE)",
        "values (#{id,jdbcType=INTEGER}, #{userId,jdbcType=VARCHAR}, ",
        "#{name,jdbcType=VARCHAR}, #{nickname,jdbcType=VARCHAR}, ",
        "#{memo,jdbcType=VARCHAR}, #{thumbnail,jdbcType=VARCHAR}, ",
        "#{startDate,jdbcType=TIMESTAMP}, #{waterAlarm,jdbcType=VARCHAR}, ",
        "#{waterCycle,jdbcType=INTEGER}, #{lastWaterDate,jdbcType=TIMESTAMP}, ",
